...
execute join(['function! vital#_fila#Async#Observable#Process#import() abort', printf("return map({'_vital_depends': '', 'start': '', '_vital_created': '', 'new': '', '_vital_loaded': ''}, \"vital#_fila#function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
delfunction s:_SID
" ___vital___
