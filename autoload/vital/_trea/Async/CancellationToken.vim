...
execute join(['function! vital#_trea#Async#CancellationToken#import() abort', printf("return map({'_vital_created': '', '_vital_healthcheck': '', 'new': ''}, \"vital#_trea#function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
delfunction s:_SID
" ___vital___
let s:STATE_OPEN = 0
