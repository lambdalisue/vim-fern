...
execute join(['function! vital#_trea#Async#File#import() abort', printf("return map({'_vital_depends': '', 'move': '', 'is_copy_dir_supported': '', 'open': '', 'copy': '', 'is_open_supported': '', 'is_move_supported': '', 'is_trash_supported': '', 'copy_dir': '', 'trash': '', '_vital_loaded': ''}, \"vital#_trea#function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
delfunction s:_SID
" ___vital___
