...
execute join(['function! vital#_trea#Vim#Window#Cursor#import() abort', printf("return map({'set_cursor': '', 'get_cursor': ''}, \"vital#_trea#function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
delfunction s:_SID
" ___vital___
