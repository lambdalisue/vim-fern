...
execute join(['function! vital#_fern#App#Flag#import() abort', printf("return map({'split': '', 'parse': '', 'flag': '', '_vital_created': '', 'value': ''}, \"vital#_fern#function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
delfunction s:_SID
" ___vital___
