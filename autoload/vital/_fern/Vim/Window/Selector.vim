...
execute join(['function! vital#_fern#Vim#Window#Selector#import() abort', printf("return map({'select': '', '_vital_depends': '', '_vital_loaded': ''}, \"vital#_fern#function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
delfunction s:_SID
" ___vital___
