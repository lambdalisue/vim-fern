...
execute join(['function! vital#_fern#Vim#Window#Locator#import() abort', printf("return map({'focus': '', 'get_thresholds': '', 'is_suitable': '', 'find': '', 'set_thresholds': '', 'attach': '', 'detach': ''}, \"vital#_fern#function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
delfunction s:_SID
" ___vital___
